// API module: defines TypeScript types (Character, HistoryItem) and provides helper functions 
// to call the backend for searching characters, fetching search history, and deleting a history item.
